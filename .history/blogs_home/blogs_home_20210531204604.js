...
function fetchAllBlogs() {
  const endpoint = `http://${hostname}/blog/api/fetch/announcements/`;
              ...
              <div class="row no-gutters">
                  ...
                  <div class="col-md-9 col-sm-push-3  order-md-1">
                      <div class="card-body">
                          ...
                          ${item.blog_object_source_name}&nbsp;&nbsp;&nbsp;&nbsp;  ${item.blog_object_published_at}</small></p>


                          <div class="mb-2">

                              <a class="text-secondary" target="__blank"
                                  href="${item.blog_object_url}">more</a>
...
$(document).ready(function () {
  $("#input-field").on("input", function () {
    ...
    if (query.length >= min_query_length) {
      ...
      fetchData(
        `http://${hostname}/blog/api/autocomplete/?search=${query}`,
